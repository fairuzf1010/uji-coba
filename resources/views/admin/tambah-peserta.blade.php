                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('user.daftarElectraAdmin') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlFile1">
                                                Unggah Kartu Pelajar/KTP/KK/Surat Pernyataan (Format
                                        ...
                                        <button type="submit" value="daftar" class="btn text-lighter" style="width: 100%; background-color: #707CAA">Daftar</button>
                                        <hr class="my-4" />
                                    </form>
                                </div>
                            </div>
