					...
					<div class="m-w-xs m-h-a">
						<div class="box box--auth" style="background-color: #181850;">
							<div class="box__content">
								<h1 class="box__title h2" style="color: white;">Welcome Back</h1>
								...
								<form action="{{ route('user.login') }}" method="post" class="form" id="register-form" data-ps-strength="">
									...
									<div class="form__actions">
										<button id="register_submit_button" type="submit" class="btn btn--primary btn--block" style="background-color: #D3247B; color: white"><span class="btn__text">Login</span><span class="btn-hover-effect"></span></button>
									</div>
								</form>
							</div>
						</div>
						<br>
						<div class="p-3 text-center m-b-0">Don't have an account yet? <a style="font-weight:bold; color: #D3247B" href="{{url('/register')}}">Sign up</a></div>
					</div>
