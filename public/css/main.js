				...
				return e = t, (i = [{
					...
					value: function (t) {
						...
						! function (t) {
							...
							return t.length >= 10
						}(e) ? this.minCharacters.removeClass("is-done") : (i++, this.minCharacters.addClass("is-done")), this.updateProgressBar(i), i >= 4 ? (this.blockSubmit = !1, this.form.addClass("password-is-strong")) : (this.blockSubmit = !1, this.form.addClass("password-is-strong"))
					}
				}, {
